    ...
    return {
        crudOptions: {
            request: {
                ...
                delRequest: async ({ row }) => await defHttp.delete(`/iam/token/${row.token}`),
            },
            ...
            columns: {
                token: {
                    title: "令牌",
                    type: "textarea",
                    column: {width: 200, fixed: "left", ellipsis: true, component: {color: "auto"}},
                    form: {
                        col: { span: 24 },
                    },
                },
            ...
            form: {
                ...
                group: {
                    ...
                    groups: {
                        baseInfo: {
                            header: "基础信息",
                            columns: ["token", "principal", "loginType", "createdName", "createdTime", "ip", "location"],
                        },
                        reqInfo: {
                            header: "请求信息",
