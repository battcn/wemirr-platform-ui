<template>
  <el-dialog :close-on-click-modal="false" :close-on-press-escape="false" title="我的头像" :visible.sync="isVisible" :width="width" class="update-avatar" top="50px">
    <el-tabs class="avatar-tabs" v-model="activeName">
      ...
      <el-tab-pane label="阿里" name="second">
...
<script>
import imgUpload from '@/components/wemirr/imgUpload'
