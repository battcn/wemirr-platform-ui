...
export default {
  ...
  mounted() {
    if(this.$route.params.dragId && this.$route.params.setting){
        this.formConf = deepClone(this.$route.params.setting)
        this.dragId = this.$route.params.dragId
        this.drawingList = deepClone(this.$route.params.setting.fields)
    }else  if(this.$route.params.dragId){
        this.dragId = this.$route.params.dragId
        this.drawingList = []
        this.idGlobal = 100
    }else{
